              ...
              <tbody>
                @foreach ($carts as $cart)
                  <tr class="parent_row">
                    ...
                    <td >
                     <span class="price_total" id="total_price_{{ $cart->id }}">
                       ${{ $cart->total }}
                     </span>
                    </td>
          ...
          <div class="row">
            ...
            <div class="col col-lg-6">
              <ul class="btns_group ul_li_right" style="float:right">
                <li><a class="btn btn-dark" href="#!">Prceed To Checkout</a></li>
              </ul>
            </div>
          </div>
        </div>
  ...
  <script>
    $(function() {
      ...
      $('.input_number_increment').on('click', function() {
        ...
        var price_total = parent_row.children('td').find('.price_total').html();
